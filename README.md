...
[**Launch predictor**](https://racepredictor-6sfeab.streamlit.app/)
---
...
```bash
git clone https://github.com/codeknight05/f1-race-predictor-final
```
**Alternative:** Download ZIP from [GitHub releases](https://github.com/codeknight05/f1-race-predictor-final/releases)
...
**Need help?** [Open an issue on GitHub](https://github.com/codeknight05/f1-race-predictor-final/issues)
